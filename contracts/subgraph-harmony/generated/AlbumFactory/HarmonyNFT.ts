...
export class SongMinted extends ethereum.Event {
  get params(): SongMinted__Params {
    return new SongMinted__Params(this);
  }
}

export class SongMinted__Params {
  _event: SongMinted;

  constructor(event: SongMinted) {
    this._event = event;
  }
...
export class HarmonyNFT extends ethereum.SmartContract {
  static bind(address: Address): HarmonyNFT {
    return new HarmonyNFT("HarmonyNFT", address);
  }
